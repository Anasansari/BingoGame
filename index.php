...
<html xmlns:fb="http://ogp.me/ns/fb#" lang="en">
  <head>
    ...
    <style type="text/css">
    h1 {
	font-family: "Lucida Calligraphy", "Lucida Console", "Lucida Handwriting";
	padding-top:5px;
	font-size: 25px;
	font-style: normal;
	font-weight: bold;
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','700','height','600','src','game/bingo','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','game/bingo' ); //end AC code
     ...
     <embed src="https://github.com/Anasansari/BingoGame/blob/master/bingo.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="700" height="600"></embed>
   </object></noscript>
 </p>  
  </div>
